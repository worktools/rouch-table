...
import { fullHeight, expand, column } from "@worktools/flex-styles";
...
let DemoWide: FC<{}> = (props) => {
  return (
    <div className={styleContainer}>
      <DocDemo title="内容横向滚动" link="https://github.com/worktools/rough-table/blob/master/example/pages/demo/wide.tsx">
      ...
      <DocDemo title="body 部分上下左右滚动(目前头部也发生滚动)" link="https://github.com/worktools/rough-table/blob/master/example/pages/demo/wide.tsx">
        <DocBlock content={content} />
