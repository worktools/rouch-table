...
let DemoBasic: FC<{}> = (props) => {
  ...
  return (
    <div className={styleContainer}>
      <DocDemo title="A very simple table" link="https://github.com/worktools/rough-table/blob/master/example/pages/demo/basic.tsx">
      ...
      <DocDemo title="Table with no data" link="https://github.com/worktools/rough-table/blob/master/example/pages/demo/basic.tsx">
